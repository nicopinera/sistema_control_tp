...
% Tiempo de simulaci\u00f3n: al menos 5 veces la constante de tiempo para observar el r\u00e9gimen estacionario.
t_sim = 10 * tau_planta;
...
#tiempo_marcado = 50; % Define el instante de tiempo que quieres marcar, por ejemplo, 50 segundos
